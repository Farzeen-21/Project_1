sap.ui.define([
    ...
    "sap/ui/core/library",
    "sap/m/library",
    "com/ibspl/leavemanagement/model/formatter",
    "sap/ui/Device"
    ...
    return Controller.extend("com.ibspl.leavemanagement.controller.Master", {
        ...
        onPressOpenGLPopover: function (oEvent) {
            ...
            if (!this._pPopover) {
                this._pPopover = Fragment.load({
                    id: oView.getId(),
                    name: "com.ibspl.leavemanagement.view.fragments.GL"
        ...
        onPressOpenCLPopover: function (oEvent) {
            ...
            if (!this._pPopover2) {
                this._pPopover2 = Fragment.load({
                    id: oView.getId(),
                    name: "com.ibspl.leavemanagement.view.fragments.CL"
        ...
        getEmployeeDetails: function (userId, msg) {
            ...
            $.ajax({
                ...
                success: function (oData, response) {
                    ...
                    if (oData.value[0].DESIGNATION === 'Consultant') {
                        ...
                        context.getTeamDetails(context.getOwnerComponent().getModel("userAttriJson").getData().EMPLOYEE_ID, msg);
        ...
        getTeamDetails: function () {
            ...
            var obj = {
                ...
                "Team": [{
                    ...
                    },
                    {
                        ...
                        "LEAVE_TYPE": "GL",
                        "NO_OF_LEAVES": "1",
                        "START_DATE": "2025-01-13T18:30:00Z"
                    },
                    {
                        "EMPLOYEE_ID": 5028,
                        "END_DATE": "2025-01-15T08:29:00Z",
                        "IS_DELETED": null,
                        "LEAVE_ID": 100194,
                        "LEAVE_NOTES": "test",
                        "LEAVE_STATUS": 1,
                        ...
                        "NO_OF_LEAVES": "0.5",
                        "START_DATE": "2025-01-15T03:30:00Z"
                    },
                    {
                        "EMPLOYEE_ID": 5028,
                        ...
                        "LEAVE_TYPE": "CL",
                        "NO_OF_LEAVES": "1",
                        "START_DATE": "2025-01-15T18:30:00Z"
                    },
                    {
                        "EMPLOYEE_ID": 5028,
                        "END_DATE": "2025-01-17T13:29:00Z",
                        "IS_DELETED": null,
                        "LEAVE_ID": 100196,
                        "LEAVE_NOTES": "test",
                        "LEAVE_STATUS": 1,
                        "LEAVE_TYPE": "GL_HALF_DAY",
                        "NO_OF_LEAVES": "0.5",
                        "START_DATE": "2025-01-17T08:30:00Z"
                    },
                    {
                        "EMPLOYEE_ID": 5028,
                        "END_DATE": "2025-01-20T13:29:00Z",
                        "IS_DELETED": null,
                        "LEAVE_ID": 100197,
                        "LEAVE_NOTES": "test",
                        "LEAVE_STATUS": 1,
                        "LEAVE_TYPE": "GL_HALF_DAY",
                        "NO_OF_LEAVES": "0.5",
                        "START_DATE": "2025-01-20T08:30:00Z"
                    },
                    {
                        "EMPLOYEE_ID": 5028,
                        "END_DATE": "2025-01-21T18:29:00Z",
                        "IS_DELETED": null,
                        "LEAVE_ID": 100200,
                        "LEAVE_NOTES": "test",
                        "LEAVE_STATUS": 1,
                        "LEAVE_TYPE": "CL",
                        "NO_OF_LEAVES": "1",
                        "START_DATE": "2025-01-20T18:30:00Z"
                    }]
                },
                {
            ...
            //     var sType;
            //     if (oData.value[i].LEAVE_STATUS === 1) {
            //         sType = CalendarDayType.Type01;
            //     } else if (oData.value[i].LEAVE_STATUS === 2 || oData.value[i].LEAVE_STATUS === 4) {
            //         sType = CalendarDayType.Type08;
            //     } else if (oData.value[i].LEAVE_STATUS === 3 || oData.value[i].LEAVE_STATUS === 5) {
            //         sType = CalendarDayType.Type02;
            //     }
            ...
            // var leaves = oArray;
            // const lastCLLeave = context.findLastLeaveByTitle(leaves, "CL");
            // const lastGLLeave = context.findLastLeaveByTitle(leaves, "GL");

            // context.getOwnerComponent().getModel("formModel").setProperty("/lastCLLeave", lastCLLeave);
            // context.getOwnerComponent().getModel("formModel").setProperty("/lastGLLeave", lastGLLeave);
        ...
        findLastLeaveByTitle: function (leaveData, title) {
            ...
            const filteredLeaves = leaveData.filter(leave => leave.title === title);
            const sortedLeaves = filteredLeaves.sort((a, b) =>
                new Date(b.endDate) - new Date(a.endDate)
            );
            if (sortedLeaves.length > 0) {
                var DateInstance = sortedLeaves[0].endDate;
            ...
            // return sortedLeaves.length > 0 ? sortedLeaves[0] : null;
        },
        ...
        onSegBtn: function (oEvent) {
            ...
            if (sKey === 'requests') {
                if (context.getOwnerComponent().getModel("userAttriJson").getProperty("/DESIGNATION") === 'Consultant') {
                    context.getOwnerComponent().getModel("formModel").setProperty("/tableForRequester", true);
